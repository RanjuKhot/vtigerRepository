...
@Test(dataProvider="getdata")
 public void data(String orgName,String pho,String email) throws Throwable
 {
    ...
    driver.findElement(By.id("phone")).sendKeys(pho);
     ...
     public Object[][] getdata()
  {
      ...
      Random ranNum = new Random();
       ...
       objArr[1][2]="mailto:abcd@gmail.com";

      objArr[2][0]="CCC"+ranNumber;
      objArr[2][1]="6956451665";
       objArr[2][2]="mailto:abce@gmail.com";
